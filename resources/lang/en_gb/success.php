...
return [
    ...
    'text_1' => 'Make sure you are using the "Cursor Style" extension on any web page (press the "F5" key once to refresh the page if cursor won\'t work for some reasons) except the Chrome Web Store, Google internal pages, and the Chrome home page, as Google’s policy prohibits the use of custom cursors on these pages. Also, for the convenience of users, the custom cursor will not be used in the extension pop-up, but to control the current cursor, it will be displayed in the “Active” field of the extension menu.',
