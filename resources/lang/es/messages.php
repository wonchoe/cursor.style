...
return [
    ...
    'vote_2' => '¡Vótanos y cuéntanos qué te parece!',
    'vote_3' => 'VOTAR',
    'vote_4' => 'AHORA NO',
    'vote_5' => 'no me muestres de nuevo',    
    'cursor_style' => 'Cursor Style',
    'cursor_style_logo_title' => 'Cursor Style logo',
    'cursor_style_logo_link' => 'images/eng-logo.svg',    
    'install' => 'Instalar',
//    
    'og_title' => 'Kits de cursor gratuitos para el navegador Chrome ©: diseñe su cursor!',
//    
    'menu_main' => 'Casa',
    'menu_how_to_use' => 'Cómo utilizar?',
    'menu_collection' => 'Colecciones',
    'menu_contact' => 'Realimentación',
//    
...
//    
    'banner_hey' => 'Oye!',
    'banner_move_your_mouse_here' => 'Vamos, pasa el cursor del mouse por aquí',
    'banner_cool' => 'Increible!',
    'banner_add_extension' => 'Instale Chrome ™ - extensión de la tienda web oficial de Google Chrome y obtenga cientos de cursores',
// OTHER
    'collection' => 'colección',
    'collections' => 'Colecciones',
    'other_collections' => 'Otras colecciones de cursores',
    'mouse_cursors' => 'Cursores del ratón',
    'main_page_no_result' => 'Su solicitud de búsqueda no coincide con ningún cursor.',    
// INSTALL BLOCK
    'install_alt' => 'Cursor Style extensión',
    'install_title' => 'Instalar Cursor Style extensión. Cambia el cursor de tu navegador en un momento!',
    'install_text_1' => 'Aún no tienes la extensión «Cursor Style»?',
    'install_text_2' => 'Instálalo desde la tienda oficial de Google Chrome™',
// MAIN PAGE
    'main_page_title' => 'Cursores de navegador geniales y divertidos: use nuestra gran colección gratuita o cargue los suyos.',
    'main_page_descr' => 'Para cambiar el cursor del mouse en su navegador, solo haga un par de clics. Nuestra colección tiene una gran cantidad de cursos para todos los gustos, además de cursos animados.',    
...
// TEST AREA
    ...
    'm_2' => 'Para agregar el cursor seleccionado, primero instale la extensión "Cursor Style" del catálogo oficial de Google Chrome.',
    'm_3' => 'Cancelar',
