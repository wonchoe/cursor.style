...
<head>
    ...
    <script async src="https://fundingchoicesmessages.google.com/i/pub-2990484856526951?ers=1"
        nonce="OTi62G9vM5_2oBSWreY35A"></script>
    <script nonce="OTi62G9vM5_2oBSWreY35A">(function () {
...
<body>
    ...
    <div class="main-container">
        ...
        <div class="footer">
            <div class="container">
                <div class="copyright">
                    © 2019–{{ now()->year }} 🖱️ Cursor.Style — by <a href="https://www.tiktok.com/@wonchoe" target="_blank">Oleksii Semeniuk</a>
                </div>
