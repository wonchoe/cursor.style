...
<script>
    ...
    function createBlock() {
        ...
        _ad_container.setAttribute('style', 'margin-top: 18px;text-align:center;display:flex; flex-direction: column;font-size: 16px;width:100%;');
        _ad_container.innerHTML = '<div style="position: relative;"><div style="position: relative;"><div onclick="window.open(\'https://gnezdo.ru\');" style="cursor: pointer;position: absolute;right: 29px;top: -21px;background: #ffffff;color: #7c9b80;font-size: 18px;width: 20px;height: 21px;line-height: 1.3;" https:="">🛈</div><div onclick="_ad_close(this)" style="cursor: pointer;position: absolute;right: 5px;top: -21px;background: #ffffff;color: #7c9b80;font-size: 18px;width: 20px;height: 21px;" data-adid="'+_ad_block_id+'">×</div></div><a style="color: #424242;text-decoration: none;" target="_blank" href="' + _ad_chosen.link + '"><img style="width: 100%;" src="' + _ad_chosen.img + '"/>\
    <div style="position: relative;display: flex;justify-content: center;"><div style="font-size: 16px; font-family: sans-serif;  padding: 5px;  font-weight: 500;">' + _ad_chosen.text + '</div></div></a>';
