...
<html>
    ...
    <body class="app">
        ...
        <script type="application/javascript">window.addEventListener('load', () => {
            ...
            @yield('src_bottom')           
            <script type="application/javascript" src="{{secure_asset('js/vendor.js')}}"></script>
            <script type="application/javascript" src="{{secure_asset('js/bundle.js')}}"></script>
