...
<div class="container-fluid">
    ...
    <form id="upload_form" name="upload_form" method="POST" action="/admin/reinit/updateani">
                        ...
                        <div class="picContainer">
                            <div class="cursor-upload">
                                ...
                                <div class="cursor-preview" id="cursor_data">
                                    ...
                                    <div id="imagePreviewCursor" style="background: url('/resources/animated/cursors/{{$item->c_file}}'); background-size: contain; ">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="pointer-upload">
                                ...
                                <div class="pointer-preview" id="pointer_data">
                                    <div id="imagePreviewPointer" style="background: url('/resources/animated/pointers/{{$item->p_file}}'); background-size: contain; ">
                                    </div>
                                </div>
                            </div>                
                        </div>
