...
function createCursorBlock(id, name, c_file, p_file) {
    ...
    <div class="admin_cur" id="c_' + id + '" style="background-image: url(&quot;/resources/animated/cursors/' + c_file + '&quot;);margin: 12px;"></div></div>\
...
$(function () {
        pic_row.style.display = 'block';
       $.get('https://cursor.style/admin/animated/getAll', function (data) {
        cursors = data.data;
