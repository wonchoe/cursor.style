...
class SeoDiscoveryCommand extends Command
{
    protected $signature = 'custom:seoSiscovery';
    protected $description = 'Заповнює таблицю seo_cursor_text всіма мовами';

    protected $languages = [
        'en', 'am', 'ar', 'bg', 'bn', 'ca', 'cs', 'da', 'de', 'el', 'es', 'et', 'fa', 'fi', 'fil', 'fr', 'gu', 'he', 'hi', 'hr', 'hu', 'id', 'it', 'ja', 'kn', 'ko', 'lt', 'lv', 'ml', 'mr', 'ms', 'nl', 'no', 'pl', 'pt', 'ro', 'ru', 'sk', 'sl', 'sr', 'sv', 'sw', 'ta', 'te', 'th', 'tr', 'uk', 'vi', 'zh'
    ];
    ...
    public function handle()
    {
        ...
        Log::channel('seojobs')->info('Запущено SeoDiscoveryCommand', ['time' => now()]);
        ...
        Cursors::chunk($batchSize, function ($cursors) use ($insertBatchSize) {
            ...
            $this->line('toInsert count: ' . count($toInsert));
